...
class Engine:
    ...
    def ac_complexity(self, tokens: list[str], rule_mode: Literal["default", "real", "permissive"] = ...) -> int: ...
    def ac_complexity_certified(self, tokens: list[str], rule_mode: Literal["default", "real", "permissive"] = ...) -> int: ...
