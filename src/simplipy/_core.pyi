...
class Engine:
    ...
    def ac_complexity(self, tokens: list[str], rule_mode: Literal["default", "real", "corpus"] = ...) -> int: ...
    def ac_complexity_certified(self, tokens: list[str], rule_mode: Literal["default", "real", "corpus"] = ...) -> int: ...
